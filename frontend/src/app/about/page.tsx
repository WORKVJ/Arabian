          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7">
              <Reveal direction="up" delay={0.1}>
                ...
                <p className="text-sm text-[#6B7280] leading-relaxed mb-6 font-sans">
                ...
                <div className="grid grid-cols-3 gap-4 pt-4 border-t border-[#D9DDE1]">
                  ...
                  <div>
                    <span className="text-xl sm:text-2xl font-display font-black text-[#111318] block">100%</span>
                    <span className="text-[10px] font-mono text-[#E8612C] uppercase font-bold block">Certified Quality</span>
                    <span className="text-[11px] text-[#6B7280]">BS EN / ISO Compliant</span>
                  </div>
                  <div>
                    <span className="text-xl sm:text-2xl font-display font-black text-[#111318] block">KSA</span>
                    <span className="text-[10px] font-mono text-[#E8612C] uppercase font-bold block">Vision 2030</span>
                    <span className="text-[11px] text-[#6B7280]">Infrastructure Partner</span>
                  </div>
                </div>
              </Reveal>
            </div>

            {/* Right: Othman Almoudi - General Manager */}
                ...
                <div className="border border-[#D9DDE1] bg-white p-3 shadow-lg group hover:border-[#E8612C] transition-colors duration-300">
                  <div className="relative aspect-[4/3] w-full overflow-hidden bg-[#0D0F12]">
                    ...
                    <div className="absolute top-3 left-3">
                      <span className="font-mono text-[9px] font-bold text-[#E8612C] bg-[#0D0F12]/90 border border-[#E8612C]/30 px-2.5 py-1 uppercase tracking-wider">
                        LEADERSHIP // KSA
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="p-4 space-y-3">
                    <div className="flex items-center justify-between border-b border-[#E5E7EB] pb-2">
                      <div>
                        <h3 className="font-display font-black text-[#111318] text-lg uppercase tracking-tight">
                          Othman Almoudi
                        </h3>
                        <p className="text-xs font-mono font-bold text-[#E8612C] uppercase">
                          General Manager
                        </p>
                      </div>
                      <span className="text-[9px] font-mono text-[#6B7280] uppercase tracking-widest bg-[#F3F4F6] px-2 py-1">
                        Arabian Gratings
                      </span>
                    </div>

                    <p className="text-xs text-[#4B5563] leading-relaxed italic border-l-2 border-[#E8612C] pl-3 font-sans">
                      &ldquo;Our commitment is anchored in unyielding structural integrity, personnel safety, and empowering Saudi Arabia&apos;s industrial future under Vision 2030.&rdquo;
                    </p>
                  </div>
                </div>
              </Reveal>
