...
export const STATIC_PROJECTS: Project[] = [
  {
    id: 1, title: 'Jeddah Red Seaport Project, KSA', slug: 'jeddah-red-seaport-project',
    location: 'Jeddah Red Seaport, KSA',
    associated_industries: [STATIC_INDUSTRIES.find(i => i.slug === 'marine-offshore') || STATIC_INDUSTRIES[1]],
    description: 'Heavy-duty hot-dip galvanized steel grids fabricated and tested for massive wheel load deflection standards across the cargo and container handling platform at Jeddah Red Seaport.',
    description_blocks: [],
    featured_image: makeMedia(1, '/img/real1/img (1).jpeg', 'Jeddah Red Seaport Project, KSA'),
    project_images: [{ id: 1, media: makeMedia(1, '/img/real1/img (1).jpeg', 'Jeddah Red Seaport Platform'), sort_order: 0 }],
    products_used: [],
  ...
  {
    id: 2, title: 'Saudi Energy Project, KSA', slug: 'saudi-energy-project',
    location: 'Saudi Arabia (KSA)',
    associated_industries: [STATIC_INDUSTRIES.find(i => i.slug === 'oil-gas') || STATIC_INDUSTRIES[0]],
    description: 'Molded GRP fiberglass composite floor walkways with high chemical safety ratios designed for severe sulphur and industrial exposure across energy utility yards.',
    description_blocks: [],
    featured_image: makeMedia(2, '/img/real2/new (10).jpeg', 'Saudi Energy Project, KSA'),
    project_images: [{ id: 2, media: makeMedia(2, '/img/real2/new (10).jpeg', 'Saudi Energy Project Walkways'), sort_order: 0 }],
    products_used: [],
  ...
  {
    id: 3, title: 'Jazan Refinery Complex — Platform Gratings', slug: 'jazan-refinery-platform-gratings',
    ...
    description_blocks: [],
    featured_image: makeMedia(3, '/project-refinery.jpg', 'Jazan Refinery Platform Gratings'),
    project_images: [{ id: 3, media: makeMedia(3, '/project-refinery.jpg', 'Jazan Refinery Gratings'), sort_order: 0 }],
    products_used: [],
  ...
  {
    id: 4, title: 'SWCC Desalination — GRP Grating Walkways', slug: 'swcc-desalination-grp-walkways',
    ...
    description_blocks: [],
    featured_image: makeMedia(4, '/project-marine.jpg', 'SWCC Desalination GRP Walkways'),
    project_images: [{ id: 4, media: makeMedia(4, '/project-marine.jpg', 'SWCC GRP Walkways'), sort_order: 0 }],
    products_used: [],
  ...
  {
    id: 5, title: 'King Abdulaziz Port — Marine Deck Gratings', slug: 'king-abdulaziz-port-marine-gratings',
    ...
    description_blocks: [],
    featured_image: makeMedia(5, '/project-marine.jpg', 'King Abdulaziz Port Marine Deck Gratings'),
    project_images: [{ id: 5, media: makeMedia(5, '/project-marine.jpg', 'Port Marine Gratings'), sort_order: 0 }],
    products_used: [],
